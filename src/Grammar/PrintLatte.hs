...
instance Print (AbsLatte.TopDef' a) where
  prt i = \case
    ...
    AbsLatte.ClsDef _ id_ clsblock -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, prt 0 clsblock])
...
instance Print (AbsLatte.Stmt' a) where
  prt i = \case
    ...
    AbsLatte.SAss _ expr1 expr2 -> prPrec i 0 (concatD [prt 6 expr1, doc (showString "="), prt 0 expr2, doc (showString ";")])
    AbsLatte.SIncr _ expr -> prPrec i 0 (concatD [prt 6 expr, doc (showString "++"), doc (showString ";")])
    AbsLatte.SDecr _ expr -> prPrec i 0 (concatD [prt 6 expr, doc (showString "--"), doc (showString ";")])
    ...
    AbsLatte.SFor _ type_ id_ expr stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id_, doc (showString ":"), prt 0 expr, doc (showString ")"), prt 0 stmt])
...
instance Print (AbsLatte.ClsBlock' a) where
  prt i = \case
    AbsLatte.ClsBlock _ clsdefs -> prPrec i 0 (concatD [doc (showString "{"), prt 0 clsdefs, doc (showString "}")])

instance Print (AbsLatte.ClsDef' a) where
  prt i = \case
    AbsLatte.ClsFldDef _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString ";")])
...
instance Print (AbsLatte.Type' a) where
  prt i = \case
    ...
    AbsLatte.TArr _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "[]")])
    AbsLatte.TCls _ id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print (AbsLatte.Expr' a) where
  prt i = \case
    ...
    AbsLatte.EApp _ id_ exprs -> prPrec i 6 (concatD [prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.EString _ str -> prPrec i 6 (concatD [printString str])
    AbsLatte.EAccFld _ expr id_ -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_])
    AbsLatte.ENewCls _ type_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_])
    AbsLatte.ENullCls _ id_ -> prPrec i 6 (concatD [doc (showString "("), prt 0 id_, doc (showString ")"), doc (showString "null")])
    AbsLatte.EArrGet _ expr1 expr2 -> prPrec i 6 (concatD [prt 6 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
